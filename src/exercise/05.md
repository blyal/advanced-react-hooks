...
- useImperativeHandle is a way to do imperative programming in React when we
  can't find a way to do it declaratively
- The use case we learned here was forwarding refs to parent components in order
  to interact with the DOM
  - Specifically in this case for the purpose of scrolling to top/bottom
- Note: can also do a forward ref by reassignment
  - e.g. function MyThing (props, ref) {} - normal declaration but with a ref
  - Then: MyThing = React.forwardRef(MyThing) – just have to disable eslint
    about this line
  - Kent uses this in the video demonstration
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=05%3A%20useImperativeHandle%3A%20scroll%20to%20top%2Fbottom&em=alexblyth%40pm.me).
